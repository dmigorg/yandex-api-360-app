# Посмотреть список сервисных приложений

Возвращает список сервисных приложений организации с их разрешениями.

## Request

```
GET https://api360.yandex.net/security/v1/org/{orgId}/service_applications
```
